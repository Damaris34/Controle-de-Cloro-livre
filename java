function gerarPDF() {
    ...
    for (let i = 0; i < fotos.length; i++) {
        ...
        reader.onload = function(e) {
            ...
            if (i === fotos.length - 1) {
                gerarPDFComDados(dataRegistro, saidaTratamento, cozinha, producao, administrativo, recebimento, fotosHTML);
            }
        };
...
function gerarPDFComDados(dataRegistro, saidaTratamento, cozinha, producao, administrativo, recebimento, fotosHTML) {
    const content = `
